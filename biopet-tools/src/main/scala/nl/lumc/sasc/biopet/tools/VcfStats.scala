...
object VcfStats extends ToolCommand {
  ...
  protected[tools] def fillGeneral(additionalTags: List[String]): Map[String, Map[String, Map[Any, Int]]] = {
    ...
    addToBuffer("SampleDistribution-Hom", 0, found = false)
    addToBuffer("SampleDistribution-HomRef", 0, found = false)
    addToBuffer("SampleDistribution-HomVar", 0, found = false)
    addToBuffer("SampleDistribution-Mixed", 0, found = false)
    addToBuffer("SampleDistribution-NoCall", 0, found = false)
    addToBuffer("SampleDistribution-NonInformative", 0, found = false)
    addToBuffer("SampleDistribution-Available", 0, found = false)
    addToBuffer("SampleDistribution-Called", 0, found = false)
    addToBuffer("SampleDistribution-Filtered", 0, found = false)
    addToBuffer("SampleDistribution-Variant", 0, found = false)
